...
//        angulo2.setDirection(Servo.Direction.REVERSE);
    ...
    @Override
    public void loop() {
        RoboTeleop teleop = new RoboTeleop(garra1,garra2,angulo1,angulo2,motorRotativo,motorsistemalinear,motorFD,motorFE,motorTD, motorTE);


        telemetry.addData("linear:", motorsistemalinear.getCurrentPosition());
        telemetry.addData("angulo: ", posServoAng);
        telemetry.addData("Encoder Do rotativo", motorRotativo.getCurrentPosition());
...
////        }
       ...
       // andar reto
        ...
        /*==========================================*/
        if(gamepad2.a || indoProIntake == true) { // pos intake
        indoProIntake = true;
        indoProOutake = false;
            //rotativo
                // posicao inicial
            ...
            if(motorRotativo.getCurrentPosition() < -18) {
...
//
//                angulo2.setPosition(0.36);
//            }
//
//        }

        if(gamepad2.b || indoProOutake == true){ //POSIÇÃO DE OUTAKE
            indoProIntake = false;
            indoProOutake = true;
            // pos back
            // 450
            if(motorRotativo.getCurrentPosition() > -450){
