...
@Disabled
@TeleOp (name = "gsas")
public class TeleopPah extends OpMode {
    DcMotor motorFD;
    DcMotor motorFE;
    DcMotor motorTD;
    DcMotor motorTE;
    ...
    public void init(){
        ...
        teleop = new RoboTeleop(garra1,garra2,angulo1,angulo2,motorRotativo,motorsistemalinear,motorFD,motorFE,motorTD, motorTE);
    }
    @Override
    public void loop() {
       ...
       /*========================================*\
        ...
        if(gamepad2.a || teleop.sistemarotativortelescopico.IndoProInitial == true) {
            ...
            if (gamepad2.b || teleop.sistemarotativortelescopico.IndoProIntake == true) {
                ...
                if (!teleop.sistemarotativortelescopico.posInicial && !teleop.sistemarotativortelescopico.IndoProInitial && !teleop.sistemarotativortelescopico.IndoProIntake && !teleop.sistemarotativortelescopico.IndoProBackDrop) {
        ...
        /*==========================================*/
                    if (gamepad2.dpad_down) { // desce
                        ...
                        if (currentPosRotativo < -1800 && !indoProIntake) { // não está embaixo
                            rotativo.virar(0.05);


                        } else if (currentPosRotativo > -700 && !indoProOutake) {
                            rotativo.virar(-0.05);
                        }
                    }
